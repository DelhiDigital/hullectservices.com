  ...
  const partners = [
    {
      id: 1,
      name: "Company One",
      logo: "./Cognizent.png?height=60&width=120",
      url: "https://example.com/1",
    },
    {
      id: 2,
      name: "Company Two",
       logo: "./vaco.jpeg?height=60&width=120",
      url: "https://example.com/2",
    },
    {
      id: 3,
      name: "Company Three",
      logo: "FamilyBazar.jpeg?height=60&width=120",
      url: "https://example.com/3",
    },
    {
      id: 4,
      name: "Company Four",
      logo: "./AdityaBirla.png?height=60&width=120",
      url: "https://example.com/4",
    },
    {
      id: 5,
      name: "Company Five",
      logo: "./Amazon.png?height=60&width=120",
      url: "https://example.com/5",
    },
    {
      id: 6,
      name: "Company Six",
      logo: "./Bajaj.png?height=60&width=120",
      url: "https://example.com/6",
    },
    {
      id: 7,
      name: "Company Seven",
      logo: "./Crossword.png?height=60&width=120",
      url: "https://example.com/7",
    },
    {
      id: 8,
      name: "Company Eight",
      logo: "./Flipcart.jpeg?height=60&width=120",
      url: "https://example.com/8",
    },
    {
      id: 9,
      name: "Company Nine",
      logo: "./Zomato.jpeg?height=60&width=120",
      url: "https://example.com/7",
    },
    {
      id: 10,
  ...
  const partners2 = [
    {
      id: 1,
      name: "Company One",
      logo: "./L&T.png?height=100&width=120",
      url: "https://example.com/1",
    },
    {
      id: 2,
      name: "Company Two",
      logo: "./Jindal.jpeg?height=60&width=120",
      url: "https://example.com/2",
    },
    {
      id: 3,
      name: "Company Three",
      logo: "./M11.png?height=60&width=120",
      url: "https://example.com/3",
    },
    {
      id: 4,
      name: "Company Four",
      logo: "./Meesho.jpeg?height=60&width=120",
      url: "https://example.com/4",
    },
    {
      id: 5,
      name: "Company Five",
       logo: "./Tivolt.png?height=60&width=120",
      url: "https://example.com/5",
    },
    {
      id: 6,
      name: "Company Six",
      logo: "./Paytm.png?height=60&width=120",
      url: "https://example.com/6",
    },
    {
      id: 7,
    ...
    },
    {
      id: 8,
      name: "Company Eight",
      logo: "./Rapido.png?height=60&width=120",
      url: "https://example.com/8",
    },
    {
      id: 9,
